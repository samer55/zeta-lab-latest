    ...
    snapshot.ref.remove();
      ...
      return (
        ...
        <TouchableOpacity  onPress={()=> this.user(data)}>
          ...
          <Text style={styles.info}><Text style={styles.bold}>سعر :</Text><Text style={{color:'red'}}>{data.price}</Text>دينار</Text>
          <Text style={styles.info}><Text style={styles.bold}>تفاصيل :</Text><Text style={{color:'red'}}>{data.title}</Text>.</Text>
</TouchableOpacity>
