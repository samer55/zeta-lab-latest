      ...
      renderModalContent1 = () => (
        ...
        renderButton3 = (text, onPress) => (
          ...
          renderModalContent3 = () => (
            ...
            <Text style={{fontSize:20,fontWeight:'bold'}}>Availabile</Text>
...
/>
   ...
   image = () => {
   this.props.navigation.navigate('la',{ uid: this.state.u})  }
   imag = () => {
   this.props.navigation.navigate('pul',{ uid: this.state.u})  }
