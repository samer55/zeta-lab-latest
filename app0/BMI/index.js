      ...
      <ImageBackground
        ...
        <View
          ...
          <View style={{justifyContent:'center',alignItems:'center'}}>
            <Text style={{fontSize:30,fontWeight:'bold',color:'#cd295a'}}>حساب كتلة الجسم</Text>

          </View>
          <View style={{justifyContent:'center',alignItems:'center',width:screenWidth,flexDirection:'column'}}>
            <Text style={{fontSize:30,fontWeight:'bold',color:'black'}}>الجنس:</Text>
            ...
            >
              ...
              <Text style={styles.TextStyle}> ذكر </Text>
            ...
            >
              ...
              <Text style={styles.TextStyle}> انثى</Text>
