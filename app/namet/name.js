      ...
      <View style={{flex:1,justifyContent:'space-between'}}>
        ...
        <ImageBackground
          ...
          <View
            ...
            <Text style={{fontSize:30,textAlign:'center',fontWeight:'bold',color:'#ffffff'}}>Ministry of Health Price only</Text>
            <TextInput
    ...
    return (
      ...
      >
        <View style={{flexDirection:'column',justifyContent:'space-around'}}>
          <Text style={{fontSize:20,fontWeight:'bold',color:'#09090a'}}>Test:<Text style={{color:'grey'}}>{data.title}</Text></Text>
          <Text style={{fontSize:20,fontWeight:'bold',color:'#09090a',textAlign:'center'}}> from: <Text style={{color:'red'}}>{data.pricef}</Text>JOD- to:<Text style={{color:'red'}}>{data.price}</Text>JOD </Text>
