...
import { Card, Header,Tile ,Divider,Text} from 'react-native-elements'
  ...
  render() {
    let shareOptions = {
      ...
      const items = [
       ...
       { name: 'Location',press:this.r2,color:'green',i:'add-location'},
...
<Modal isVisible={this.state.visibleModal === 1}>
  ...
  onPressPlace = () => {
     ...
     return (
       <View style={styles.headerContainer}>
           ...
           <View style={styles.headerColumn}>
            ...
            <Icon color='green' style={{borderRadius:20,borderWidth:1,padding:6}}
            size={30} name="call" />
             <Thumbnail square
   ...
   image = () => {
   this.props.navigation.navigate('labsimg',{ uid: this.state.u})  }
   imag = () => {
   this.props.navigation.navigate('prom',{ uid: this.state.u})  }
