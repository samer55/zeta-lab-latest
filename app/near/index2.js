         ...
         <View style={{flexDirection:'row',justifyContent:'space-around'}}>
           <Form>
                     ...
                     >
                       ...
                       <Picker.Item label="60km" value="60000" />
                       <Picker.Item label="70km" value="70000" />
                       <Picker.Item label="80km" value="80000" />
                       <Picker.Item label="90km" value="90000" />
...
<Icon name="earth" color="steelblue" size={30}/>
         ...
         <Text style={{color:'white',padding:5}}>My current location</Text>
       </Button>
         <Button primary style={{alignSelf:'center'}} onPress={this.maps} >
         <Text style={{color:'white',padding:5,alignSelf:'center'}}>Find Labs</Text>
       </Button>
     </View>
     </View>
