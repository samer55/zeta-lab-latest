...
uid:this.props.navigation.state.params.uid,
      ...
      renderModalContent1 = () => (
        ...
        renderButton3 = (text, onPress) => (
          ...
          renderModalContent3 = () => (
            ...
            <Text style={{fontSize:20,fontWeight:'bold'}}>متاح</Text>
  ...
  render() {
    let shareOptions = {
      ...
      const items = [
       { name: 'تأمين',press:this.image,color:'red',i:'image'},
       { name: 'عروض',press:this.imag,color:'blue',i:'local-offer'},
       { name: 'الموقع',press:this.r2,color:'green',i:'add-location'},
       { name: 'المعلومات',press:this.r3,color:'black',i:'info'},
     ];
    return (
      <ScrollView style={styles.scroll}>
        <View style={styles.container}>
