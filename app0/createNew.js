...
this.getLocationHandler()
 ...
 render() {
   ...
   if (this.state.locationChosen) {
     marker = <MapView.Marker         style={{width:30,height:30}}      image={require('./marker1.png')}
