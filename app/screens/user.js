...
import { Card, Header,Tile ,Divider,Text,CheckBox} from 'react-native-elements'
import ImagePicker from 'react-native-image-picker'
import { Segment ,Button, Tab, Tabs ,List,ListItem,Left,Right,Body,Thumbnail} from 'native-base';
...
uid:this.props.navigation.state.params.uid,
      ...
      renderModalContent1 = () => (
        ...
        renderButton3 = (text, onPress) => (
          ...
          renderModalContent3 = () => (
            ...
            <Icon name='access-time' size={50} color='red' style={{alignSelf:'flex-start'}} />
            <View style={{flexDirection:'column'}}>
            <Text style={{fontSize:20,fontWeight:'bold'}}>Availability</Text>

            <View style={{flexDirection:'row'}}>

            <Text style={{fontSize:16,color:'grey'}}>{this.state.time1} - {this.state.time2}</Text>
            <Text>:</Text>
            <Text style={{fontSize:16,color:'grey'}}>{this.state.week1} - {this.state.week2}</Text>
</View>
</View>
            ...
            <Text style={{fontSize:15,fontWeight:'200',alignSelf:'center',marginBottom:20}}>
            {this.state.info}
            </Text>
  ...
  r = () => this.setState({ visibleModal: 1 });
  r1 = () => this.setState({ visibleModal: 2 })
  r2 = () => Linking.openURL(this.state.loc);;
  r3 = () => this.setState({ visibleModal: 4 });
  ...
  render() {
    let shareOptions = {
      ...
      const items = [
       { name: 'Insurance',press:this.image,color:'red',i:'image'},
       { name: 'Offers',press:this.imag,color:'blue',i:'local-offer'},
       { name: 'place',press:this.r2,color:'green',i:'add-location'},
       { name: 'Info',press:this.r3,color:'black',i:'info'},
     ];
    return (
      <ScrollView style={styles.scroll}>
        <View style={styles.container}>
        ...
        <View style={{justifyContent:'center',alignItems:'center',borderRadius:17,borderWidth:1,borderColor:'grey',padding:40,shadowOpacity: 0.75,
        shadowRadius: 5,
        shadowColor: 'grey',
...
<Modal isVisible={this.state.visibleModal === 1}>
     ...
     return (
       <View style={styles.headerContainer}>
           ...
           <View style={styles.headerColumn}>
            ...
            <Icon color='black' style={{borderRadius:20,borderWidth:1,padding:6}}
            size={30} name="call" />
            </TouchableOpacity>
             <Thumbnail square
               style={{width:150,height:150,margin:20,borderRadius:1,borderColor:'grey',borderWidth:0.2}}
               source={{
             ...
             <TouchableOpacity onPress={()=>{
               Share.share({
            message: `check out my ${this.state.name} lab at zeta lab app
            https://play.google.com/store/apps/details?id=com.labjo
            https://itunes.apple.com/app/id1455233650`,
            ...
            excludedActivityTypes: [
             ...
             <Icon color='red' style={{borderRadius:20,borderWidth:1,padding:6}}
             size={30} name="share" />
             </TouchableOpacity>
   </View>
             <View style={styles.userAddressRow}>
               <View>
              <Text h1 style={{fontSize:30,fontWeight:'bold',margin:5}}>{this.state.name}</Text>
              <CheckBox
    center
    title='home services Debit'
  ...
  />
   ...
   image = () => {
   this.props.navigation.navigate('uimg',{ uid: this.state.u})  }
   imag = () => {
   this.props.navigation.navigate('pu',{ uid: this.state.u,name:this.state.name})  }
