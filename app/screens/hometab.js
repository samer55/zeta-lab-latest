...
export default class Hometab extends Component {
  ...
  render() {
    const items = [
     { name: 'Price of Test', img: image1 ,press:this._openChat},
     { name: 'Promotion', img: image2,press:this._openprom},
     { name: 'Summary', img: image3,press:this._opensum},
     { name: 'Near By', img: image4,press:this._opencity},
        ...
        <View
          ...
          <TouchableOpacity onPress={() => this._openbmi()} style={{width:screenWidth}} >
            <ImageBackground
              ...
              style=  {styles.imagee}               >
              <View
                style={{width:screenWidth,height:80,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(255, 255, 255, 0.3)'}} ><Text style={styles.paragraph}>Calculation of BMI</Text></View>
            </ImageBackground>
...
borderRadius={20}             >
                <View style={{position: 'absolute', borderRadius:19,top: 0, left: 0, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center',  shadowColor: "black",
            backgroundColor:'rgba(255, 255, 255, 0.4)'}} ><Text style={styles.paragraph}>{item.name}</Text></View>
                </ImageBackground>
              </TouchableOpacity>
